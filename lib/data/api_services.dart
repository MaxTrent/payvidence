...
class ApiServices {
  ...
  Future<void> resendOtp() async {
    await _makeRequest<void>(
      endpoint: ApiUrls.resendOtp, // Make sure this URL exists
      method: HttpMethod.post,
      parser: (_) {},
    );
  }
  ...
  Future<LoginModel> login({required String email,required String password,required String deviceName}) async{
return _makeRequest(endpoint: ApiUrls.login, method: HttpMethod.post, parser: LoginModel.fromJson,
body: {
  "email": email,
  "password": password,
