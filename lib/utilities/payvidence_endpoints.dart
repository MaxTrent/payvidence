class PayvidenceEndpoints {
  ...
  static String forgotPasswordComplete(String userId) =>
      '/api/account/$userId/forgot-password/new-password';
  static String get resetPasswordInit => '/api/account/reset-password';
  static String get resetPasswordComplete =>
  ...
  static String get refreshToken => '/api/account/refresh-token';
  ...
  static String getBusiness(String businessId) => '/api/business/$businessId';
...
//Notification Endpoints
  ...
  static String getOneNotification(String notificationId) =>
...
//Client Endpoints
  ...
  static String getClient(String businessId, String clientId) =>
      "/api/business/$businessId/client/$clientId";
  static String listClients(String businessId) =>
      "/api/business/$businessId/client";
  static String deleteClient(String businessId, String clientId) =>
      "/api/business/$businessId/client/$clientId";
  static String updateClient(String businessId, String clientId) =>
      "/api/business/$businessId/client/$clientId";
