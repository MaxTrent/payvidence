          ...
          children: [
           ...
           SizedBox(height: 32.h,),
            ...
            Row(
              ...
              children: [
                Text('Enable Biometric login', style: Theme.of(context).textTheme.displaySmall!.copyWith(
                    fontSize: 22.sp
                ),),
                CupertinoSwitch(value: isBiometricEnabled.value, onChanged: (value){
                  toggleBiometricLogin(value);
                }, activeColor: primaryColor2, thumbColor: appGrey,trackColor: borderColor,)
              ],
            ),
            SizedBox(height: 11.h,),
            Text('You will be able to log in to Payvidence App using your biometrics once enabled.', style: Theme.of(context).textTheme.displaySmall!.copyWith(
                fontSize: 16.sp
            ),),
