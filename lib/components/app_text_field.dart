...
class AppTextField extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveHeight = responsiveData.scaleHeight(height);
    final effectiveWidth = width != null ? responsiveData.scaleWidth(width!) : null;
    final effectiveRadius = responsiveData.scaleHeight(radius);
