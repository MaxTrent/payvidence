    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
           recommended ? Container(height: 26.h, width: 108.w,
            
            decoration: BoxDecoration(color: Color(0xff7767BD),
            borderRadius: BorderRadius.circular(6.r)),
              child: Center(
                child: Text('RECOMMENDED',
                style: Theme.of(context).textTheme.displaySmall!.copyWith(fontSize: 12.sp, color: Colors.white),),
              ),
            ): const SizedBox.shrink(),
            recommended ? SizedBox(height: 10.h,) : const SizedBox.shrink(),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Row(
            ...
            checkOut ? SizedBox(height: 4.h,): const SizedBox.shrink(),
            checkOut ? Row(
